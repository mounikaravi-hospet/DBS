...
select at2.waiter_id, count(at2.customer_id) 
from customer c left join attends_to at2 on c.customer_id = at2.customer_id 
group by at2.waiter_id,c.dining_date having dining_date = '2021-12-02'  
